...
RUN GOOS=windows GOARCH=amd64 go build -ldflags "-X github.com/bhaney/rtsp-simple-server/internal/core.version=$$VERSION" -o tmp/rtsp-simple-server.exe
...
RUN GOOS=linux GOARCH=amd64 go build -ldflags "-X github.com/bhaney/rtsp-simple-server/internal/core.version=$$VERSION" -o tmp/rtsp-simple-server
...
RUN GOOS=darwin GOARCH=amd64 go build -ldflags "-X github.com/bhaney/rtsp-simple-server/internal/core.version=$$VERSION" -o tmp/rtsp-simple-server
...
RUN GOOS=linux GOARCH=arm GOARM=6 go build -ldflags "-X github.com/bhaney/rtsp-simple-server/internal/core.version=$$VERSION" -o tmp/rtsp-simple-server -tags rpicamera
...
COPY --from=rpicamera32 /s/internal/rpicamera/exe/exe internal/rpicamera/exe/
RUN GOOS=linux GOARCH=arm GOARM=7 go build -ldflags "-X github.com/bhaney/rtsp-simple-server/internal/core.version=$$VERSION" -o tmp/rtsp-simple-server -tags rpicamera
...
RUN GOOS=linux GOARCH=arm64 go build -ldflags "-X github.com/bhaney/rtsp-simple-server/internal/core.version=$$VERSION" -o tmp/rtsp-simple-server -tags rpicamera
